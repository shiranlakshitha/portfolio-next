...
`;
  ...
  return (
    ...
    <div className="z-10 absolute inset-0 flex flex-col justify-center items-center h-full px-[10px]">
      <p className='text-[16px] font-inter text-center text-[#E4ECFF]'>Dynamic Web Development with Next.js & Beyond</p>
    ...
    <div
      ref={mountRef}
      className={`absolute inset-0 w-full h-full overflow-hidden pointer-events-none touch-none ${className || ''}`}
      style={style}
    />
